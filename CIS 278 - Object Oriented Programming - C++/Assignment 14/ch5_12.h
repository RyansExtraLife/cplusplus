...
//  Assignment 14
//
//  Created by Ghizmo on 9/24/13.
//  Copyright (c) 2013 Ryan Michael. All rights reserved.
//

#ifndef Assignment_14_ch5_12_h
#define Assignment_14_ch5_12_h
...
class DrawingPatternsWithNestedLoops{
    ...
    void patternWithNestedLoops(){
        ...
        for(counter =1; counter <= 11; counter ++){
            ...
            if (counter == 11) for (recounter = 1; recounter <=10; recounter ++){
                if (recounter == 2) cout << "*********";
                if (recounter == 3) cout << "********";
                if (recounter == 4) cout << "*******";
                if (recounter == 5) cout << "******";
                ...
                if (recounter == 10) for(spacecounter =1; spacecounter <= 10; spacecounter ++){
                    ...
                    if (spacecounter == 10) for (spacerecounter =1; spacerecounter <=10; spacerecounter ++){
    ...
    void patternWithNestedLoopsV2(){
        ...
        for (addingAsterics =1; addingAsterics <= 10; addingAsterics ++){
            ...
            if (addingAsterics == 10)for (subtractingAsterics =1; subtractingAsterics <=10; subtractingAsterics++){
                ...
                if (subtractingAsterics ==10) for (addingSpaces =1; addingSpaces <=10; addingSpaces ++){
                    ...
                    if (addingSpaces <=10) cout << "*";
                    if (addingSpaces <=10) cout << "\n";
                    if (addingSpaces == 10) for(subtrackingSpaces =1; subtrackingSpaces <=10; subtrackingSpaces ++){
